...
date: '2024-03-22 08:27:41 +0000'
slug: micro-benchmarking-value-objects-in-ruby-datadefine-vs-struct-vs-openstruct
subtitle: Exploring performance of Data.define vs Struct and OpenStruct
tags:
- ruby
- ruby-on-rails
- performance
- programming-blogs
description: 'Compare `Data.define`, `Struct`, `OpenStruct` in Ruby: object creation
  and accessing attributes'
image: "/assets/images/posts/micro-benchmarking-value-objects-in-ruby-datadefine-vs-struct-vs-openstruct/54d8b470-89df-4ead-9f6c-d26d5c75680d.png"
last_modified_at: '2024-03-29 07:07:20 +0000'
---
...
![Jean Boussier explaining "It's not because it's written in Ruby but because of it's semantic.  For every single instance it has to create a metaclass and define methods on it. It's terribly wasteful and doing the same in C wouldn't be much faster.  OpenStruct should be considered deprecated really."](/assets/images/posts/micro-benchmarking-value-objects-in-ruby-datadefine-vs-struct-vs-openstruct/4d2394ac-51f8-4e8e-b7a2-7e84d69235b1.png)
