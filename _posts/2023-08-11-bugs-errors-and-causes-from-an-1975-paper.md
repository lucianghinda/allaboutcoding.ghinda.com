...
date: '2023-08-11 02:41:12 +0000'
slug: bugs-errors-and-causes-from-an-1975-paper
subtitle: Half of the errors may result from factors other than the code itself.
tags:
- bugs-and-errors
- errors
- programming-tips
description: '1975 paper: analyzing system program bugs, stressing problem definition,
  domain knowledge, diverse error categories for software quality'
image: "/assets/images/posts/bugs-errors-and-causes-from-an-1975-paper/2e2e77e5-39f4-42c0-98cc-56a3948d38ab.png"
last_modified_at: '2023-08-11 02:57:37 +0000'
---
...
!["Almost half of all errors are found in the area of understanding the problem, problem communication and of the knowledge of possibilities and procedures for problem-solving"](/assets/images/posts/bugs-errors-and-causes-from-an-1975-paper/060b5daa-657b-41c9-bbfe-a40cccd1ae2c.png)
...
![](/assets/images/posts/bugs-errors-and-causes-from-an-1975-paper/ac6a15bd-2a23-4328-8c10-9b74359a0f7a.png)
