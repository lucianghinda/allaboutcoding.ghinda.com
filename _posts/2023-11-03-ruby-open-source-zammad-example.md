...
date: '2023-11-03 03:52:55 +0000'
slug: ruby-open-source-zammad-example
subtitle: Another example of an open source web app written in Ruby
tags:
- ruby
- ruby-on-rails
- programming-blogs
- coding
- opensource
description: 'Explore Zammad: open-source Ruby ticketing system with cloud, custom
  styling, multiple databases, and service objects on Ruby 3.1.3, Rails 7'
image: "/assets/images/posts/ruby-open-source-zammad-example/94aeb1b5-df0d-48b1-a725-e14dfb466096.png"
last_modified_at: '2024-01-11 09:30:42 +0000'
---
...
[![](/assets/images/posts/ruby-open-source-zammad-example/7f4332e3-f201-4b13-9665-edcc4b62ba93.png)](https://zammad.com/en)
...
[![](/assets/images/posts/ruby-open-source-zammad-example/cb56b30a-549e-425b-b779-aa6d0c4439fc.png)](https://github.com/zammad/zammad)

## Licensing

The license is [GNU AGPL](https://github.com/zammad/zammad/blob/develop/LICENSE)

[![](/assets/images/posts/ruby-open-source-zammad-example/a97191ad-5d59-4f61-b9f4-d310eda87e2d.png)](https://github.com/zammad/zammad/blob/develop/LICENSE)

They [mention on their website](https://zammad.com/en/company/open-source) why they chose to make the product open source:

[![](/assets/images/posts/ruby-open-source-zammad-example/df787418-80d9-4629-9b45-12104b3fca55.png)](https://zammad.com/en/company/open-source)

Each file in the repository has a license line like:

[![](/assets/images/posts/ruby-open-source-zammad-example/626b9c49-9262-47c2-a3b2-144bf95f9728.png)](https://github.com/zammad/zammad/blob/develop/Gemfile)
...
![Result of executing rails stats on the repo](/assets/images/posts/ruby-open-source-zammad-example/424bdfb1-3437-4fb2-a49a-6e421b6066b4.png)
...
![](/assets/images/posts/ruby-open-source-zammad-example/e9580f24-8d99-4bf4-a9cd-df14a0726516.png)
...
![Code sample from MySQL DB preflight check](/assets/images/posts/ruby-open-source-zammad-example/90dad251-2dda-44dc-86e4-842e72de559e.png)
...
[![](/assets/images/posts/ruby-open-source-zammad-example/c087e526-1895-4740-b0a0-261223e24d47.png)](https://github.com/zammad/zammad/blob/develop/app/services/service/base_with_current_user.rb)
...
[![](/assets/images/posts/ruby-open-source-zammad-example/969eb9ec-d08d-47ed-9877-7a8d8a5c7b9b.png)](https://github.com/zammad/zammad/blob/develop/app/jobs/application_job/has_queuing_priority.rb)
...
[![](/assets/images/posts/ruby-open-source-zammad-example/e23db320-1e38-4684-b485-2e42f50ec466.png)](https://github.com/zammad/zammad/blob/develop/app/models/application_model.rb)
