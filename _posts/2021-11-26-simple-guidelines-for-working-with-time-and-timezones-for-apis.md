---
layout: post
title: Simple guidelines for working with Time and TimeZones for APIs
date: '2021-11-26 08:31:23 +0000'
slug: simple-guidelines-for-working-with-time-and-timezones-for-apis
tags:
- ruby
- apis
- rest-api
- ruby-on-rails
- guide
description: "Working with DateTime or Time and timezones can be sometimes confusing.
  \nHere are some guidelines that I defined while working with dates/times. They are
  working well in Rails (meaning Rails is already doing some requires transformations
  especially w..."
image: ''
---
