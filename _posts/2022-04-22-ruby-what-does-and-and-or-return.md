---
layout: post
title: 'Ruby: What does && and || return?'
date: '2022-04-22 05:25:08 +0000'
slug: ruby-what-does-and-and-or-return
tags:
- ruby
- programming-tips
- coding
- programming
description: "How do these things work?\nHave you ever wondered how the following
  code works? Specifically, how come the key will have another value than true or
  false. \nkey = loaded_key || Key.find(params[:key])\n\nor maybe how does the simple
  memorization pattern w..."
image: "/assets/images/posts/ruby-what-does-and-and-or-return/_fZmuZxrY.png"
last_modified_at: '2022-04-22 05:33:59 +0000'
---
