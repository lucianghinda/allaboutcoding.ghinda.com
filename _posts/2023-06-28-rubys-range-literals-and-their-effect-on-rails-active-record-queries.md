...
date: '2023-06-28 09:40:26 +0000'
slug: rubys-range-literals-and-their-effect-on-rails-active-record-queries
subtitle: Learn about the difference between inclusive and exclusive end ranges and
  the SQL queries each choice produces
tags:
- ruby
- ruby-on-rails
- active-record
description: Investigate Ruby range literals in Rails Active Record queries, comparing
  SQL generation for inclusive/exclusive ranges
image: "/assets/images/posts/rubys-range-literals-and-their-effect-on-rails-active-record-queries/b8ceb6e1-0262-409c-a34f-c384ea7d6f88.png"
---
...
[![](/assets/images/posts/rubys-range-literals-and-their-effect-on-rails-active-record-queries/3d317949-9371-444d-9ef6-3e4f5a207b40.png)](https://www.postgresql.org/docs/current/functions-comparison.html)
...
[![](/assets/images/posts/rubys-range-literals-and-their-effect-on-rails-active-record-queries/f1580101-8ebb-4a15-ace5-4e864f02ec18.png)](https://docs.ruby-lang.org/en/3.2/syntax/literals_rdoc.html#label-Range+Literals)
