...
date: '2025-10-15 04:36:51 +0000'
slug: ruby-on-rails-loading-locales-with-yes-no-on-and-off
tags:
- ruby
- ruby-on-rails
- gems
description: Ruby on Rails uses `psych` for YAML locale processing that will load
  Yes/No, On/Off as booleans
image: "/assets/images/posts/ruby-on-rails-loading-locales-with-yes-no-on-and-off/61a08276-fb05-418b-af46-24907ce52018.png"
last_modified_at: '2025-10-17 03:25:52 +0000'
---
...
[![Screenshot from YAML version 1.1](/assets/images/posts/ruby-on-rails-loading-locales-with-yes-no-on-and-off/ed80e4a1-d4d5-4edc-a8f0-551249a50941.png)](https://yaml.org/type/bool.html)
...
![Screenshot of Neovim displaying an error message about using yes, no as locales key](/assets/images/posts/ruby-on-rails-loading-locales-with-yes-no-on-and-off/2b5457f6-efb1-4f43-8097-bfc111ed5a43.png)

![Screenshot of Zed displaying an error mesaage about using `on` as key in locales](/assets/images/posts/ruby-on-rails-loading-locales-with-yes-no-on-and-off/23879934-6c61-4b3a-9b7d-1cc95db1d1cf.png)
