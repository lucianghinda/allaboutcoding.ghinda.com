...
- programming-blogs
- programming-tips
description: Learn about hash value omission in Ruby, their benefits, examples, and
  implementation guidelines for more concise code
image: "/assets/images/posts/hash-value-omission-an-introduction-and-some-examples/7ff5695e-5939-467c-8572-94af8cc5bd82.png"
last_modified_at: '2024-07-24 12:25:45 +0000'
---
...
![](/assets/images/posts/hash-value-omission-an-introduction-and-some-examples/e6a884e8-5440-4ef9-86db-8cabaae70326.png)
...
![A post by Akinori MUSHA (@knu@mr.am) discusses the implementation of pattern-matching with value omission. It gives an example using  and explains that it is shorthand for .](/assets/images/posts/hash-value-omission-an-introduction-and-some-examples/0436b692-54fa-4925-a611-ed122173bea0.png)

![A post by Akinori MUSHA describing how he convinced Matz to introduce value omission in hash literal syntax for symmetry. The tweet includes Ruby code defining  and  methods, and a method call showing  returns 42 when decomposed.](/assets/images/posts/hash-value-omission-an-introduction-and-some-examples/cf2aa606-1c54-4404-9f93-32c15a5db4b1.png)
...
![](/assets/images/posts/hash-value-omission-an-introduction-and-some-examples/38a3cc8d-3b2d-4a99-a486-093fd95faef8.png)

And here is an example from pattern matching (but in pattern matching this kind of syntax is common):

![](/assets/images/posts/hash-value-omission-an-introduction-and-some-examples/e185ec9f-5546-412d-b2c6-a6d6548b4b9f.png)
