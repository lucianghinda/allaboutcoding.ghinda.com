---
layout: post
title: API Design - choosing status code for a GET route
date: '2022-02-05 05:15:47 +0000'
slug: api-design-choosing-status-code-for-a-get-route
tags:
- rest-api
- apis
- design-patterns
...
description: |-
  ...
  they are idempotent: every time you call the route with the same params it should give you the same result and nothing should change...
image: ''
---
