---
layout: post
title: How to update multiple different values at the same time in one query
date: '2022-04-01 06:27:48 +0000'
slug: how-to-update-multiple-different-values-at-the-same-time-in-one-query
subtitle: How to create a raw SQL to update in Rails different values for each record
  in one single query
tags:
- ruby-on-rails
- databases
...
image: "/assets/images/posts/how-to-update-multiple-different-values-at-the-same-time-in-one-query/IDxttkAGj.png"
last_modified_at: '2022-04-01 14:17:09 +0000'
---
