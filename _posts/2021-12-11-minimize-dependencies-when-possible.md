---
layout: post
title: Minimize dependencies when possible
date: '2021-12-11 16:33:59 +0000'
slug: minimize-dependencies-when-possible
subtitle: When to write your own code and when to use an existing library
tags:
- ruby
- ruby-on-rails
- programming-tips
- coding
- learning
description: "This is more like general advice, but when possible minimize dependencies.
  \nI will write the following examples with Ruby gems in mind but could be used in
  any other programming environment that supports packages. \nWhy minimize external
  dependencies\n..."
image: ''
---
